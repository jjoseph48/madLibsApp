...
let questionArray = ["Masukkan kata benda :", "Masukkan kata kerja :", "Masukkan kata benda :", "Masukkan nama hewan :", "Masukkan kata kerja :", "Masukkan nama hewan :", 
"Masukkan kata kerja :","Masukkan kata kerja :"];
    
let userInputs = [];
for (let i = numberOfQuestion-1; i >= 0; i--){
    console.log(
